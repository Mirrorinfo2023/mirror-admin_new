...
import Transactions from "@/components/setting1/bbps_rpanel";
import { Grid,Paper,TableContainer, Button } from "@mui/material";
import { Typography,Divider,Box,TextField} from "@mui/material";

import AddBBPSVendorForm from '@/components/setting1/add-new-vendor-bbps'; 
...
function TransactionHistory(props) {
    ...
    useEffect(() => {
        const getTnx = async () => {
          ...
          try {
            const response = await api.post('/api/setting1/bbpsrecharge-panel', reqData);
    ...
    return (
        ...
        <Layout>
            ...
            <AddBBPSVendorForm open={openForm} onClose={handleCloseForm}/>
        </Layout>
