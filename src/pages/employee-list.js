...
function TransactionHistory() {
    ...
    const cards = [
        {
            label: "Total",
            value: masterReport.totalempCount ?? 0,
            color: "#3B82F6",
            bgColor: "#EFF6FF"
        },
        {
            label: "Active",
            value: masterReport.totalActiveempCount ?? 0,
            color: "#10B981",
            bgColor: "#ECFDF5"
        },
        {
            label: "Inactive",
            value: masterReport.totalInactiveempCount ?? 0,
            color: "#EF4444",
            bgColor: "#FEF2F2"
        }
    ];
            ...
            <Box sx={{ p: 0.5 }}>
                ...
                <Box sx={{ mb: 0.5, px: 0.5 }}>
                    <Typography variant="caption" sx={{ 
                        ...
                        Showing {filteredRows.length} employees
                    </Typography>
                </Box>
            </Box>
