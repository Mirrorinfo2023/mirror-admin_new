                        ...
                        <Table aria-label="User Transaction Summary Table" exportButton={true}>
                            <TableHead>
                                <TableRow>
                                    ...
                                    <StyledTableCell style={{ fontWeight: 'bold', whiteSpace: 'nowrap' }}>Consumer Mobile No.</StyledTableCell>
                                    <StyledTableCell style={{ fontWeight: 'bold', whiteSpace: 'nowrap' }}>Recharge Status</StyledTableCell>
                                    ...
                                    {/* <StyledTableCell style={{ fontWeight: 'bold', textWrap: "nowrap" }} align="right">Login Time</StyledTableCell>
                                    <StyledTableCell style={{ fontWeight: 'bold', textWrap: "nowrap" }} align="right">Logout Time</StyledTableCell> */}
                                </TableRow>
                            </TableHead>
                            <TableBody>
                                ...
                                {showServiceTrans.length > 0 ? (rowsPerPage > 0
                                    ...
                                    >
                                        ...
                                        <StyledTableCell>{row.recharge_type + ' | ' + row.service_name}</StyledTableCell>
                                        ...
                                        <StyledTableCell>{row.recharge_status}</StyledTableCell>
                                        ...
                                        {/* <StyledTableCell>{row.loginTime && getDate(row.loginTime)}</StyledTableCell>
                                        <StyledTableCell>{row.logoutTime && getDate(row.logoutTime)}</StyledTableCell> */}
