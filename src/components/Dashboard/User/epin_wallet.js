                            ...
                            <TableBody>
                                ...
                                {showServiceTrans.length > 0 ? (rowsPerPage > 0
                                    ...
                                    >
                                        ...
                                        <StyledTableCell fontWeight="bold" style={{ color:row.tran_for === 'Add Money' ? 'Blue' : row.tran_for === 'Recharge' ? 'orange' : row.tran_for === 'Refund' ? 'Red' : row.tran_for === 'System Credit' ? 'Green': 'Black' }} >{row.tran_for}</StyledTableCell>
